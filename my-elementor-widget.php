...
final class MY_Elementor_Widget {
    ...
    */
    public function scripts_styles() {
        ...
        wp_register_style( 'slick-theme-style', MYEW_PLUGIN_URL . 'assets/slick/slick-theme.css', [], rand(), 'all' );       
        wp_register_style( 'gridlex-style', MYEW_PLUGIN_URL . 'assets/source/css/gridlex.css', [], rand(), 'all' );
        wp_register_script( 'myew-script', MYEW_PLUGIN_URL . 'assets/source/js/public.js', [ 'jquery' ], rand(), true );
      wp_register_script( 'slick-script', MYEW_PLUGIN_URL . 'assets/slick/slick.js', [ 'jquery' ], rand(), true );
        wp_enqueue_style( 'myew-style' );
        wp_enqueue_style( 'slick-style' );
        wp_enqueue_style( 'slick-theme-style' );
        wp_enqueue_style( 'gridlex-style' );
    ...
    */
    public function init_widgets() {
        require_once MYEW_PLUGIN_PATH . '/widgets/post-types.php';
